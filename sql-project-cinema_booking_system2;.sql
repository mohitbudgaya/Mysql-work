...
-- student name MOHIT--
-- ------------------(creating database Cinema_booking_system )-----------------------------
...
describe screenings;
alter table screening rename to screenings;
...
-- ------------------------------- ( question series )-------------------
-- 1. How many bookings did the customers with ID 10 make. i total.
...
-- -------------------------- (Questions)------------------------------------------
-- 1. select the customers id and count the number of reserved seat 
-- grouped by customers and sort the result by customer ID.

-- 2. select the film name  count the numner of screenings for each film that is over 2 hours long.

-- 3. Modify the query from question 2 so that is count screnings only for january 2023.

-- 4. Find out how many seats each customer has booked for each screening.
-- include the customer ID ,the screening ID and the number of seat for each customers
-- for that screenings.
...
-- -----------------------------(sub query questions)----------------------- --
-- 1.select the film name and lenght for all films with a lenght greather then the lenght of average film lenght.alter.

-- 2. select the maximum and minimum number of screenings for our film
-- we want two value in result the maximum number of screening and the minimum number of screening 

-- 3. select each film and the number of screening for that film.
...
-- 1. concate the film names and lenghts from the film table .

-- 2.Extract the customer email from the fifth character onward
 -- we want the end of ther email from fifth character.
 
-- 3. select the customers first name in lowercase and last name in uppercse
...
-- 1. which five customers made the most bookings.
...
-- 2. in caplin room which film shown most.
